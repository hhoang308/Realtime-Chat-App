...
class SignInForm(ft.UserControl):
    ...
    def build(self):
        ...
        self.text_signin=ft.ElevatedButton(text="Sign in",color=ft.colors.BLACK,bgcolor=ft.colors.WHITE,width=150,height=50,on_click= self.btn_signin)
        self.text_signup = ft.Row(
            controls=[
                ...
                ft.TextButton(
                    ...
                    style=ft.ButtonStyle(color=ft.colors.BLACK)  # Set text color using style
                ),
            ],
